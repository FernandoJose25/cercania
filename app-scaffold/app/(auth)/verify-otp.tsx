...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: Colors.bg, alignItems: 'center', paddingHorizontal: Spacing.xl, paddingTop: 52 },
  headerBg: { position: 'absolute', top: 0, left: 0, right: 0, height: 200, backgroundColor: Colors.bgAlt, borderBottomLeftRadius: 40, borderBottomRightRadius: 40 },
  backBtn: { alignSelf: 'flex-start', width: 40, height: 40, borderRadius: 20, backgroundColor: Colors.surface, alignItems: 'center', justifyContent: 'center', marginBottom: Spacing.xl, ...Shadows.card },
  ...
  iconRing: { position: 'absolute', width: 110, height: 110, borderRadius: 55, borderWidth: 2, borderColor: Colors.primaryLight },
  iconRing2: { position: 'absolute', width: 130, height: 130, borderRadius: 65, borderWidth: 1, borderColor: Colors.borderBlue },
  title: { ...Typography.h1, color: Colors.text, textAlign: 'center', marginBottom: Spacing.sm },
  subtitle: { ...Typography.body, color: Colors.textSoft, textAlign: 'center' },
  boldText: { fontWeight: '700', color: Colors.text },
  emailBadge: { backgroundColor: Colors.primaryLight, borderRadius: Radius.pill, paddingHorizontal: 16, paddingVertical: 6, marginTop: Spacing.sm, marginBottom: Spacing.xl },
  emailText: { ...Typography.bodyBold, color: Colors.primary },
  ...
  digitBoxCurrent: { borderColor: Colors.primary, borderWidth: 2.5 },
  digitText: { ...Typography.h2, color: Colors.primary },
  tapHint: { ...Typography.small, color: Colors.textMuted, marginBottom: Spacing.xl },
  verifyBtn: { width: '100%' },
  resendRow: { flexDirection: 'row', marginTop: Spacing.lg },
  resendText: { ...Typography.body, color: Colors.textSoft },
  countdownText: { ...Typography.bodyBold, color: Colors.textMuted },
  resendLink: { ...Typography.bodyBold, color: Colors.primary },
  infoBox: { marginTop: Spacing.xl, backgroundColor: Colors.primaryLight, borderRadius: Radius.lg, padding: Spacing.md, width: '100%' },
  infoText: { ...Typography.caption, color: Colors.primaryDark, textAlign: 'center' },
});