...
const styles = StyleSheet.create({
  ...
  mapCard: {
    width: 240, height: 178, backgroundColor: '#1C1917', borderRadius: Radius.xl, overflow: 'hidden',
    borderWidth: 2, borderColor: '#F59E0B55', ...Shadows.floating,
  },
  ...
  pinBubble: { alignItems: 'center', justifyContent: 'center', borderWidth: 2.5, borderColor: 'rgba(255,255,255,0.2)', ...Shadows.card },
  ...
  connLine: { position: 'absolute', height: 1.5, backgroundColor: '#F59E0B55' },
  liveBadge: {
    position: 'absolute', top: 10, right: 10, flexDirection: 'row', alignItems: 'center', gap: 5,
    backgroundColor: 'rgba(16,185,129,0.2)', borderRadius: Radius.pill, paddingHorizontal: 10, paddingVertical: 4,
  },
  liveDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: Colors.accent },
  liveText: { fontSize: 11, fontWeight: '700', color: '#10B981' },
  floatCard: {
    position: 'absolute', backgroundColor: '#1C1917', borderRadius: 16, padding: 10, alignItems: 'center',
    ...Shadows.card, borderWidth: 1, borderColor: '#292524',
  },
  floatLabel: { fontSize: 10, fontWeight: '700', color: '#A8A29E', marginTop: 2 },

  content: { paddingHorizontal: Spacing.xl, paddingTop: Spacing.md },
  badge: { alignSelf: 'flex-start', backgroundColor: 'rgba(245,158,11,0.15)', borderRadius: Radius.pill, paddingHorizontal: 14, paddingVertical: 6, marginBottom: Spacing.md },
  badgeText: { ...Typography.label, color: '#F59E0B' },
  title: { ...Typography.display, color: '#FAFAF9', marginBottom: Spacing.md },
  subtitle: { ...Typography.body, color: '#A8A29E', lineHeight: 23, marginBottom: Spacing.md },
  pillsRow: { flexDirection: 'row', flexWrap: 'wrap', gap: Spacing.sm },
  pill: { backgroundColor: '#1C1917', borderRadius: Radius.pill, paddingHorizontal: 12, paddingVertical: 5, borderWidth: 1, borderColor: '#292524' },
  pillText: { ...Typography.small, fontWeight: '600', color: '#A8A29E' },

  buttons: { paddingHorizontal: Spacing.xl, paddingBottom: Spacing.xxxl, paddingTop: Spacing.lg },
  termsText: { ...Typography.small, color: '#78716C', textAlign: 'center', marginTop: Spacing.lg, lineHeight: 18 },
  termsLink: { color: '#F59E0B', fontWeight: '700' },
  recoveryBtn: { alignItems: 'center', marginTop: Spacing.lg, paddingVertical: Spacing.sm },
  recoveryText: { ...Typography.caption, color: '#78716C', textDecorationLine: 'underline' },
});
